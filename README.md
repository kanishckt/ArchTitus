...
```
pacman -Sy git
git clone https://github.com/kanishckt/ArchTitus
cd ArchTitus
./archtitus.sh
```

### System Description
This is completely automated arch install. It includes prompts to select your desired desktop environment, window manager, AUR helper, and whether to do a full or minimal install. The KDE desktop environment has two options one is vanilla the other one includes some extra packages, as well as some customizations.
...
## Credits
- ChrisTitusTech for the amazing script located here - https://github.com/ChrisTitusTech/ArchTitus
